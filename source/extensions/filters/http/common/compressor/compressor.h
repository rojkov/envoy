...
public:
  ...
  public:
    ...
    virtual bool compressionEnabled() const override {
      return is_set_ && compression_enabled_.enabled();
    }
  ...
  public:
    ...
    virtual bool compressionEnabled() const override { return compression_enabled_.enabled(); }
