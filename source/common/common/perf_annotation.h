...
public:
   ...
   * finished and recorded with a corresponding end() call. The measurement can
   * be started and ended in different scopes.
   *
   * @param category the name of a category for the recording.
   * @param description the name of description for the recording.
   */
...
private:
  ...
  TimestampsMap timestamps_map_ ABSL_GUARDED_BY(mutex_);
